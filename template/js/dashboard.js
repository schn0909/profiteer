(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      var riderCost = $('#rider_cost').val().split(",");
      var revenue = $('#revnue').val().split(",");
      var profit = $('#profit').val().split(",");
      // console.log()
      const pointRadius = Array(revenue.length).fill(4);
      const pointHoverRadius = Array(revenue.length).fill(2);
      console.log("RiderCost =>", riderCost);
